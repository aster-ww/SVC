"""
Train SVC on the Xenium breast cancer section. Multi-scale k=4/16/64
...
Usage:
    ...
    python train.py --data-root /path/to/data --out-dir ./output     
"""
...
ap.add_argument('--out-dir', default='./output/xenium_breast_cancer',
...
val_data   = np.load(f"{dataset_dir}/val_xenium_breast_cancer.npz")
...
rank0_print(f"[xenium_breast_cancer] Train: {train_image.shape[0]}, Val: {n_val}")
...
rank0_print(f"Starting xenium_breast_cancer training "
...
if IS_RANK0:
    if best_state_dict is not None:
        ...
        print(f"\nxenium_breast_cancer done. Best epoch: {best_epoch}, "
