...
Usage:
    python evaluate.py --data-root /path/to/data --ckpt-dir ./output/xenium_mouse_brain
"""
...
ap.add_argument('--ckpt-dir', default='./output/xenium_mouse_brain',
...
RELEASED_CKPT = 'checkpoint_Xenium_mouse_brain.pth'
...
test_data  = np.load(f"{dataset_dir}/test_xenium_mouse_brain.npz")
...
print(f"[xenium_mouse_brain] Test cells: {test_image.shape[0]}, "
